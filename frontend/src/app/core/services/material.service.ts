...
export class MaterialService {
  ...
  listarMaterialesPorModulo(moduloId: number, page = 0, size = 10, search = '', sort = 'fechaSubida,desc'): Observable<any> {
    return this.http.get<any>(`${this.baseApiUrl}/materiales/modulo/${moduloId}`, {
      params: {
        page: String(page),
        size: String(size),
