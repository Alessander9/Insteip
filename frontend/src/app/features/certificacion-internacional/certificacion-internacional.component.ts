...
export class CertificacionInternacionalComponent {
  ...
  beneficios: Beneficio[] = [
    ...
    },
    {
      ...
      description: 'Al certificarte con INSTEIP accedes a una red de profesionales y egresados activos en más de 15 países.'
    },
    {
      icon: 'security',
      title: 'Respaldo Institucional',
      description: 'INSTEIP emite certificados con sello institucional, firma del director académico y número de registro único.'
    }
  ];
  ...
  pasos: Paso[] = [
    ...
    },
    {
      ...
      description: 'INSTEIP emite tu certificado digital con código único de verificación en un plazo de 5 días hábiles.'
    },
    {
      numero: '04',
      icon: 'download',
  ...
  reconocimientos: Reconocimiento[] = [
    { pais: 'Perú', bandera: '🇵🇪', descripcion: 'País sede y origen académico de INSTEIP' },
