...
export class AromaterapiaFloresBachComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  docenteData: DocenteData = {
    ...
    especialidades: [
      ...
      { icon: 'verified', label: 'Docente Autorizada INSTEIP' }
    ]
  };
  ...
  ctaData: CourseCtaData = {
    ...
    faqs: [
      ...
      { icon: 'verified', pregunta: '¿El certificado tiene valor curricular?', respuesta: 'Sí, recibirás tu certificación oficial emitida por el Instituto Superior de Terapias Integrales INSTEIP.' },
    ...
    trustText: 'Reserva segura · Respaldo institucional INSTEIP · Cupos estrictamente limitados'
  };
