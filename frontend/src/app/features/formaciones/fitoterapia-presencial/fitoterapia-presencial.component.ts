...
export class FitoterapiaPresencialComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ctaData: CourseCtaData = {
    ...
    beneficios: [
      ...
      'Incluye certificado emitido por INSTEIP',
    ...
    faqs: [
      ...
      { icon: 'verified', pregunta: '¿Incluye certificado?', respuesta: 'Sí, recibirás tu certificación oficial emitida por INSTEIP al finalizar la formación.' },
    ...
    trustText: 'Reserva segura · Respaldo institucional INSTEIP · Acceso inmediato a material didáctico'
  };
