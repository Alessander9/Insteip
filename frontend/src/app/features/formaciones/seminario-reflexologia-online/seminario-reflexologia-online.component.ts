  ...
  get ctaData(): CourseCtaData {
    return {
      ...
      faqs: [
        ...
        { icon: 'verified', pregunta: '¿Incluye certificado?', respuesta: 'Sí, recibirás un certificado de participación oficial emitido por INSTEIP.' },
      ...
      trustText: 'Pago seguro · Respaldo institucional INSTEIP · Ponente Internacional de primer nivel'
    };
  }
