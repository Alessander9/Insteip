  ...
  readonly libros: LibroItem[] = [
    {
      ...
      autor: 'Equipo de Especialistas MTC INSTEIP',
      ...
      portada: 'assets/AcupunturaInsteip2.jpg',
      destacado: true,
      bestseller: true,
    ...
    },
    {
      ...
      autor: 'Dirección Académica INSTEIP',
      ...
      anio: 'Edición 2026',
      formato: 'PDF Digital HD',
      portada: 'assets/Auriculoterapia Insteip.jpg',
      bestseller: true,
    ...
    },
    {
      ...
      autor: 'Área de Fisioterapia & Terapias Manuales INSTEIP',
      ...
      anio: 'Edición 2026',
      formato: 'PDF Digital HD',
      portada: 'assets/MasajeDigitoPresionInsteip.jpg',
    ...
    },
    {
      ...
      autor: 'Docencia Botánica & Fitoterapia INSTEIP',
      ...
      anio: 'Edición 2026',
      formato: 'PDF Digital HD',
      portada: 'assets/fitoterapia_insteip.jpg',
    ...
    },
    {
      ...
      autor: 'Especialistas en Nutrición Integrativa INSTEIP',
      ...
      anio: 'Edición 2026',
      formato: 'PDF Digital HD',
      portada: 'assets/insteip_dietetica.jpg',
    ...
    },
    {
      ...
      autor: 'Cuerpo Docente en MTC INSTEIP',
      categoria: 'Acupuntura & MTC',
      categoriaSlug: 'acupuntura',
      precioSoles: 42,
      paginas: 160,
    ...
    },
    {
      ...
      autor: 'Especialistas en Reflexología INSTEIP',
      categoria: 'Masaje & Terapias Manuales',
      categoriaSlug: 'manuales',
      precioSoles: 45,
      paginas: 180,
  ...
  on3DBookViewDetails(event: { item: NewsletterBookshelfItem; index: number }): void {
    ...
    if (matched) {
      ...
      const fallback: LibroItem = {
        ...
        subtitulo: event.item.subtitle || 'Publicación y material de estudio oficial del Instituto INSTEIP.',
        autor: event.item.author || 'Cuerpo Docente INSTEIP',
        ...
        formato: 'PDF Digital HD',
        portada: 'assets/AcupunturaInsteip2.jpg',
        resumen: event.item.subtitle || 'Texto clínico y de referencia formativa para terapeutas y estudiantes de INSTEIP.',
        capitulos: [
        ...
        etiquetas: ['INSTEIP', 'Publicación Oficial', 'MTC']
      };
